...
NL2SQL_SYSTEM_PROMPT: str = """你是 SQLite 查询生成器。根据用户问题和表结构生成 SELECT 语句。
...
class NL2SQLTranslator:
    ...
    def translate(
        ...
        system_prompt: str = NL2SQL_SYSTEM_PROMPT.format(
            schema=schema,
            examples=examples,
...
class RecommendedQuestionsGenerator:
    ...
    RECOMMEND_SYSTEM_PROMPT: str = """你是一个电商数据问答系统的推荐引擎。根据用户刚才的提问和系统回答，生成3个用户可能感兴趣的后续问题。
